...
public class recuperarRecordatorio extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem option_menu){
        ...
        if (id==R.id.action_menu_1){
            Intent intent = new Intent(recuperarRecordatorio.this, agregarEtiqueta.class);
            startActivity(intent);
        }
        if (id==R.id.action_menu_2){
            Intent intent = new Intent(recuperarRecordatorio.this, mapa.class);
            startActivity(intent);
        }
        if (id==R.id.action_menu_3){
            Intent intent = new Intent(recuperarRecordatorio.this, Settings_remty.class);
            startActivity(intent);
        }
        ...
        if (id==R.id.action_menu_5){
            Intent intent = new Intent(recuperarRecordatorio.this, developerListActivity.class);
            startActivity(intent);
        }
        return false;
    }
